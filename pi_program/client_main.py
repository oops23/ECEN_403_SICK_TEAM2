""" SICKSense Agripollinate Client Main Version 1.0 
    Created by:    Josiah Faircloth 
    date:    11/30/2025

    Compatible with Master Main Version 1.0
    ...
    a unique timestamped filename. Direct copy of Image Client Version 0.3.
"""
